...
public class SecondMapAnimator {

    private static SecondMapAnimator mapAnimator;
    ...
    private SecondMapAnimator() {

    }

    public static SecondMapAnimator getInstance() {
        if (mapAnimator == null) {
            mapAnimator = new SecondMapAnimator();
        }
        return mapAnimator;
    }
    ...
    public void animateRoute(GoogleMap googleMap, List<LatLng> bangaloreRoute) {
        ...
        ValueAnimator colorAnimation = ValueAnimator.ofObject(new ArgbEvaluator(), GREY, ContextCompat.getColor(DrawRouteMaps.getContext(), R.color.delivery_user));
